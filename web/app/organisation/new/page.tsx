			...
			<div className='flex flex-row justify-around items-start'>
				...
				<form className='flex flex-col items-center w-2/5 mt-20 gap-10'>
					<div className="grid w-full items-center gap-3">
						...
						<Input
							name='title'
							type="text" id="title" placeholder="Enter title here"
							onChange={handleChange}
							value={formData.title}
						/>
					</div>
					<div className="grid w-full items-center gap-3">
						<Label htmlFor="title" className='font-normal'>Description</Label>
						<Textarea
							name='description'
					...
					<div className="grid w-full items-center gap-3">
						<Label htmlFor="title" className='font-normal'>Logo</Label>
				...
				<div className='flex gap-3'>
					<Button variant='outline' className='rounded-md text-[#376789] border-[#376789]'>
						Cancel
					</Button>
